...
Coupling <- function(N,stype,vtype,Rain,ETp) {
...
# write here:
# riverheads <- Whatever value from the sheet as a starting value (negative in m)

source("gwt_input_parameters.txt") #out because otherwise: overwrite veg,soil,climate data 
...
Coupling(N=10,stype="L Med Clay", vtype="TreesNoDR",Rain=Rain, ETp=ETp)
