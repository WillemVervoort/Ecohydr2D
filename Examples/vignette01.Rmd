...
## step 3 define the soils and vegetation
...
## step 4 Run the model over the grid cells
...
# Second example: a river with a constant flow 
...
# Third example: using different vegetation at the sites  
