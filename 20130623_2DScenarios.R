...
gw_in <- seq(-8,-12,length=42) #finalgw 
...
bwplot(Tg*10+Ts*10  ~as.factor(loc),data=Out,subset=loc<100,
...
xyplot(stress~as.Date(Dates)|as.factor(loc),data=Out, subset=loc<95, 
